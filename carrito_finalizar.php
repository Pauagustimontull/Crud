...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">PauTienda</a>
...
$con = mysqli_connect($servidor,$usuario,$password,$bd);
    ...
    while($fila=$consulta->fetch_assoc()){
        ...
        ?>
            ...
            <td  style="width:15px">  <a href="/Tienda/eliminar.php?id=<?php echo $fila['ID']?>"> <button class="btn btn-danger"   >Eliminar</button> </td></a>
